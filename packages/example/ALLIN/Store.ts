 ...
 */
export const Store_Inventory_GET = (...args: any): Promise<ApiResponseWrapper<object>> => {
  return adaptorFn(
    {
      url: `/store/inventory`,
      method: "GET",
 ...
 */
export const Store_Order_POST = (parameter: ALLIN.IOrder = {} as any, ...args: any): Promise<ApiResponseWrapper<ALLIN.IOrder>> => {
  return adaptorFn(
    {
      url: `/store/order`,
      method: "POST",
 ...
 */
export const Store_Order_OrderId_$PATH$_GET = (parameter: string = "", ...args: any): Promise<ApiResponseWrapper<ALLIN.IOrder>> => {
  return adaptorFn(
    {
 ...
 */
export const Store_Order_OrderId_$PATH$_DELETE = (parameter: string = "", ...args: any): Promise<ApiResponseWrapper<any>> => {
  return adaptorFn(
    {
      url: `/store/order/${parameter}`,
      method: "DELETE",
