 ...
 */
export const Pet_POST = (...args) => {
  return adaptorFn(
    {
      url: `/pet`,
      method: "POST",
      bonusInfo: {
        namespace: "OUT_JAVASCRIPT",
        description: "pet: Addanewpettothestore",
        apiName: "Pet_POST",
        path: `/pet`,
        method: `POST`,
 ...
 */
export const Pet_FindByStatus_GET = (parameter = {}, ...args) => {
  return adaptorFn(
    {
 ...
 */
export const Pet_FindByTags_GET = (parameter = {}, ...args) => {
  return adaptorFn(
    {
      url: `/pet/findByTags`,
      method: "GET",
 ...
 */
export const Store_Order_POST = (...args) => {
  return adaptorFn(
    {
      url: `/store/order`,
      method: "POST",
 ...
 */
export const User_CreateWithArray_POST = (...args) => {
  return adaptorFn(
    {
 ...
 * @description: user: Createslistofuserswithgiveninputarray
 */
export const User_CreateWithList_POST = (...args) => {
  return adaptorFn(
    {
 ...
 */
export const User_Login_GET = (parameter = "", ...args) => {
  return adaptorFn(
    {
      url: `/user/login`,
      method: "GET",
 ...
 */
export const User_Logout_GET = (...args) => {
  return adaptorFn(
    {
      url: `/user/logout`,
      method: "GET",
 ...
 */
export const User_Username_$PATH$_GET = (parameter = "", ...args) => {
  return adaptorFn(
    {
      url: `/user/${parameter}`,
      method: "GET",
 ...
 * @description: user: Thiscanonlybedonebytheloggedinuser.
 */
export const User_Username_$PATH$_PUT = (parameter = "", ...args) => {
  return adaptorFn(
    {
      url: `/user/${parameter}`,
      method: "PUT",
 ...
 * @description: user: Thiscanonlybedonebytheloggedinuser.
 */
export const User_Username_$PATH$_DELETE = (parameter = "", ...args) => {
  return adaptorFn(
    {
      url: `/user/${parameter}`,
      method: "DELETE",
