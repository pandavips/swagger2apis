 ...
 */
export const PetPOST = (parameter: BASE.IPet = {} as any, ...args: any): Promise<any> => {
  const parameter = {
    url: `/pet`,
    method: "POST",
    parameter,
 ...
 */
export const PetPUT = (parameter: BASE.IPet = {} as any, ...args: any): Promise<any> => {
  const parameter = {
    url: `/pet`,
    method: "PUT",
    parameter,
 ...
 */
export const Pet_FindByStatusGET = (...args: any): Promise<BASE.IPet[]> => {
  const parameter = {
 ...
 */
export const Pet_FindByTagsGET = (...args: any): Promise<BASE.IPet[]> => {
  const parameter = {
    url: `/pet/findByTags`,
    method: "GET",
    bonusInfo: {
 ...
 */
export const Pet_PetId_$petId$GET = (parameter: string = "", ...args: any): Promise<BASE.IPet> => {
  const parameter = {
    url: `/pet/${parameter}`,
    method: "GET",
    parameter,
 ...
 */
export const Pet_PetId_$petId$POST = (parameter: string = "", ...args: any): Promise<any> => {
  const parameter = {
    url: `/pet/${parameter}`,
    method: "POST",
    parameter,
 ...
 */
export const Pet_PetId_$petId$DELETE = (parameter: string = "", ...args: any): Promise<any> => {
  const parameter = {
    url: `/pet/${parameter}`,
    method: "DELETE",
    parameter,
 ...
 */
export const Pet_PetId_UploadImage_$petId$POST = (parameter: string = "", ...args: any): Promise<BASE.IApiResponse> => {
  const parameter = {
 ...
 */
export const Store_InventoryGET = (...args: any): Promise<object> => {
  const parameter = {
    url: `/store/inventory`,
    method: "GET",
    bonusInfo: {
 ...
 */
export const Store_OrderPOST = (parameter: BASE.IOrder = {} as any, ...args: any): Promise<BASE.IOrder> => {
  const parameter = {
    url: `/store/order`,
    method: "POST",
    parameter,
 ...
 */
export const Store_Order_OrderId_$orderId$GET = (parameter: string = "", ...args: any): Promise<BASE.IOrder> => {
  const parameter = {
 ...
 */
export const Store_Order_OrderId_$orderId$DELETE = (parameter: string = "", ...args: any): Promise<any> => {
  const parameter = {
    url: `/store/order/${parameter}`,
    method: "DELETE",
    parameter,
 ...
 */
export const UserPOST = (parameter: BASE.IUser = {} as any, ...args: any): Promise<any> => {
  const parameter = {
    url: `/user`,
    method: "POST",
    parameter,
 ...
 */
export const User_CreateWithArrayPOST = (parameter: BASE.IUser[] = {} as any, ...args: any): Promise<any> => {
  const parameter = {
 ...
 * @description: user: Createslistofuserswithgiveninputarray
 */
export const User_CreateWithListPOST = (parameter: BASE.IUser[] = {} as any, ...args: any): Promise<any> => {
  const parameter = {
 ...
 */
export const User_LoginGET = (...args: any): Promise<string> => {
  const parameter = {
    url: `/user/login`,
    method: "GET",
    bonusInfo: {
 ...
 */
export const User_LogoutGET = (...args: any): Promise<any> => {
  const parameter = {
    url: `/user/logout`,
    method: "GET",
    bonusInfo: {
 ...
 */
export const User_Username_$username$GET = (parameter: string = "", ...args: any): Promise<BASE.IUser> => {
  const parameter = {
    url: `/user/${parameter}`,
    method: "GET",
    parameter,
 ...
 * @description: user: Thiscanonlybedonebytheloggedinuser.
 */
export const User_Username_$username$PUT = (parameter: string = "", ...args: any): Promise<any> => {
  const parameter = {
    url: `/user/${parameter}`,
    method: "PUT",
    parameter,
 ...
 * @description: user: Thiscanonlybedonebytheloggedinuser.
 */
export const User_Username_$username$DELETE = (parameter: string = "", ...args: any): Promise<any> => {
  const parameter = {
    url: `/user/${parameter}`,
    method: "DELETE",
    parameter,
